...
void mInput(List* lp)
{
	...
	while (1) {
		...
		res = scanf_s("%d", &inData);	/* scanf()함수의 리턴 값 : 정수 입력 시 1, 문자 입력 시 0리턴 됨*/
		if (res == 0) {	/* 문자 입력 시 종료 */
			myflush();
			break;
		}
...
void mSearch(List* lp)
{
	...
	while (1) {
		...
		res = scanf_s("%d", &sData);	/* scanf()함수의 리턴 값 : 정수 입력 시 1, 문자 입력 시 0리턴 됨*/
		if (res == 0) {		/* 문자 입력 시 종료 */
			myflush();
			break;
		}
...
void mDelete(List* lp)
{
	...
	while (1) {
		...
		res = scanf_s("%d", &delData);	/* scanf()함수의 리턴 값 : 정수 입력 시 1, 문자 입력 시 0리턴 됨*/
		if (res == 0) {		/* 문자 입력 시 종료 */
			myflush();
			break;
		}
